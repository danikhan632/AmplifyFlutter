...
class DefaultApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [NewPetResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<NewPetResponse>> createPet({ 
    required NewPet newPet,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(newPet, specifiedType: _type);
    ...
    NewPetResponse _responseData;

    try {
      const _responseType = FullType(NewPetResponse);
    ...
    return Response<NewPetResponse>(
      data: _responseData,
  ...
  Future<Response<Pet>> getPet({ 
    ...
    final _path = r'/pets/{petId}'.replaceAll('{' r'petId' '}', petId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<JsonObject>> petsOptions({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<JsonObject>> petsPetIdOptions({ 
    required String petId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
